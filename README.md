...
[![WebSubHub Docs Publish](https://github.com/wso2/docs-websubhub/actions/workflows/publish_docs.yaml/badge.svg)](https://github.com/wso2/docs-websubhub/actions/workflows/publish_docs.yaml)
...
To access the WSO2 Integrator: WebSubHub documentation site, visit https://websubhub.docs.wso2.com/.

Follow the below topics to learn more:

- [Contributing to WebSubHub documentation](#contribute)
...
## <a name="contribute"></a> Contributing to WebSubHub documentation

As an open-source project, WebSubHub documentation welcomes contributions from the community. Before you contribute, read the following guidelines to understand how you can contribute:
...
3. The `docs-websubhub/en/docs/` directory contains all the `.md` files with content. Find the relevant location and do the modification.
...
4. Navigate to the `docs-websubhub/en/` directory in the terminal and build the repository with the following command:
...
Fork the GitHub repository: https://github.com/wso2/docs-websubhub.git
...
Navigate to the location where you want to clone the repository and clone the forked repository.
   ...
   ```shell
   git clone https://github.com/<git-username>/docs-websubhub.git
   ```
...
2. Open the following URL on a new browser window to view the Micro Integrator documentation site locally:
   ...
   >
   > 1. Open the `mkdocs.yml` file located in the `docs-websubhub/en/docs/` directory.
   >
